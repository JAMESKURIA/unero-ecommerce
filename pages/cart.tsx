	...
	return (
		<div className="px-6 md:px-12 lg:px-20">
			...
			<div className="py-6 mt-8">
				...
				<div className="hidden md:flex items-center justify-around text-gray-600 bg-gray-100 py-6 my-6">
					<h3>Product Name</h3>
					<h3>Price</h3>
					<h3>Quantity</h3>
					<h3>Total</h3>
			...
			{/* Buttons */}
			<div className="flex flex-col md:flex-row gap-4 md:justify-between my-8 mb-20 px-4">
				<Link href={"/shop"}>
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-8  p-10 mb-10">
