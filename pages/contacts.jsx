...
const Contacts = () => {
  return (
    <div>
      ...
      <h3 className="text-center w-3/6 mx-auto text-gray-600 mb-20">
        If you need any help, please contact us or sen us an email or go to our
        forum. We are sure that you can receive our reply as soon as possible
      </h3>

      <div className="grid grid-cols-3 gap-8 mb-20">
        <div className="border border-gray-300 p-10 flex flex-col gap-3">
          <BsTelephone className="text-red-400 text-4xl mb-3" />
          <h3 className="font-semibold text-2xl text-gray-700">Phone</h3>
        ...
        <div className="border border-gray-300 p-10 flex flex-col gap-3">
          ...
          <h3 className="font-semibold text-2xl text-gray-700">Address</h3>
          <div className="flex flex-col">
            <span className="text-gray-500 font-semibold">Kabuku, Limuru</span>
            <span className="text-gray-500 font-semibold">Kenya.</span>
          </div>
        </div>
        <div className="border border-gray-300 p-10 flex flex-col gap-3">
          <AiOutlineMail className="text-red-400 text-4xl mb-3" />
          <h3 className="font-semibold text-2xl text-gray-700">Email</h3>
          <div className="flex flex-col">
            <span className="text-gray-500 font-semibold">
              support@nickjames.co.ke{" "}
            </span>
            <span className="text-gray-500 font-semibold">hello@unero.co</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col">
        ...
        <form action="" className="my-8 grid grid-cols-3 gap-10">
          ...
          <div className="col-span-3 items-center flex justify-center">
            <button className="flex w-fit h-fit  items-center justify-center py-3 px-6 bg-black text-white px-3 hover:text-black hover:bg-gray-100">
              <span>Submit</span>
            </button>
          </div>
        </form>
