	...
	return (
		<div className="px-6 md:px-12 lg:px-20">
			<div className="pt-10 pb-14">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					...
					<div className="flex items-center justify-center relative">
						...
						<div className="hidden md:flex flex-col gap-2 absolute top-0 left-0 h-2/3 w-24">
							<Slider {...settings2}>
								{[1, 2, 3, 4, 5].map((prod) => (
					...
					<div className="flex flex-col gap-4">
						{/* brand */}
						<h3 className="font-bold uppercase text-blue-500 text-sm">
							{" "}
							DG
						</h3>
						...
						<p className="text-gray-600 mb-4 leading-8">
							...
							elit. Rem, debitis adipisci ducimus dolor dolorum
							inventore ex natus pariatur assumenda commodi
						</p>
						...
						<div className="flex gap-2 h-10 my-8">
							<button className="px-4 inline-flex items-center border border-gray-300 rounded hover:bg-gray-50 transition-colors">
								<FiMinus />
							</button>
							<input
								type="number"
							...
							<button
								...
								className="inline-flex justify-center items-center border border-gray-300 text-white bg-gray-900 px-10 rounded hover:bg-gray-800 transition-colors"
							>
								Add to cart
							</button>
						</div>
			...
			<div className="my-10 flex flex-col">
				{/* nav */}
				<div className="py-8 flex flex-wrap items-center justify-center space-x-8 text-gray-700">
				...
				{/* Description */}
				<div className="flex flex-col gap-10 leading-10 px-4 md:px-0">
					{/* Detail */}
					<div>
						...
						<p className="text-gray-700 w-9/12 leading-7 ">
							Lorem ipsum dolor sit amet, consectetur adipisicing
							elit. Adipisci illum nulla doloremque, illo quia
							placeat voluptatem ab magni doloribus atque tempore
							in et labore, accusamus nisi deleniti qui. Cum,
							consequuntur.
						</p>
					</div>
					...
					<div>
						...
						<ul>
							...
							<li className="text-gray-700 list-disc ml-5">
								Sapiente optio, harum exercitationem ab sint
								asperiores
							</li>
							<li className="text-gray-700 list-disc ml-5">
								Deserunt molestias voluptatem quasi provident
								omnit
							</li>
							<li className="text-gray-700 list-disc ml-5">
				...
				{/* Tags */}
				<div className="w-full my-10 border-t border-b border-gray-300 flex flex-col md:flex-row items-center justify-center py-4 text-sm gap-4 md:space-x-8 mt-20">
