...
const SingleNews = () => {
	return (
		<div className="px-6 md:px-12 lg:px-20">
			...
			<div className="w-full md:w-5/6 mx-auto py-20 flex flex-col gap-10">
          ...
          accusantium.
			...
			{/* Controls - Next && Prev */}
			<div className="flex flex-col md:flex-row gap-4 justify-between py-10 mb-20">
				<div className="space-y-3 hover:bg-gray-100 p-4 border cursor-pointer border-gray-300 rounded transition-colors">
				...
				<div className="text-gray-500 cursor-not-allowed space-y-3 hover:bg-gray-100 p-4 border border-gray-300 rounded transition-colors">
