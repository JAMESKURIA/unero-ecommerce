  ...
  return (
    <>
      ...
      <div className="grid grid-cols-3 gap-10 ">
        <main className="col-span-2 mb-20">
          <div className="py-10 font-medium flex space-x-6 text-lg text-gray-500">
            <h3 className="text-red-500 cursor-pointer hover:text-red-500 ">
              All
            </h3>
            <h3 className="cursor-pointer hover:text-red-500">Inspiration</h3>
            <h3 className="cursor-pointer hover:text-red-500">Design</h3>
            <h3 className="cursor-pointer hover:text-red-500">Fashion</h3>
            <h3 className="cursor-pointer hover:text-red-500">Art</h3>
          </div>
        ...
        <aside className="mb-20 sticky top-0">
          <button className="border border-gray-300 flex items-center my-6">
            <input
              type="text"
              placeholder="Search"
              className=" pl-3 py-2 outline-none"
            />
            <span className="text-xl p-2 py-3  text-gray-400 font-semibold">
              <FiSearch />
            </span>
          </button>
