...
export default function Home() {
  ...
  return (
    <>
      <div className="h-96 bg-gray-100 flex  items-center justify-around px-6 md:px-0">
      ...
      <div className=" md:h-96 h-80 bg-gray-100 mb-20 flex justify-around items-center px-6 md:px-0">
        <div>
